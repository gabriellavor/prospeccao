...
@Component({
  selector: 'app-cliente-paginacao',
  templateUrl: './cliente-paginacao.component.html',
  styleUrls: ['./cliente-paginacao.component.scss']
})
export class ClientePaginacaoComponent implements OnInit {
    ...
    ngOnInit() {
      this.qtdAdjacentes = this.qtdAdjacentes || ClientePaginacaoComponent.ADJACENTES_PADRAO;
      this.qtdPorPagina = this.qtdPorPagina || ClientePaginacaoComponent.TOTAL_PAGS_PADRAO;
      this.pagina = +this.route.snapshot.queryParams['pagina'] || ClientePaginacaoComponent.PAG_PADRAO;
      this.totalRegistros = this.totalRegistros || ClientePaginacaoComponent.REG_PADRAO;
