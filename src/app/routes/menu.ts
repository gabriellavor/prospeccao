...
const Graficos = {
    ...
    submenu: [
        {
            text: 'Ramo Atividade',
            link: '/graficos/ramo-atividade'
        },
        {
            text: 'Leads X Clientes',
            link: '/graficos/cliente-leads'
        },
        {
            text: 'Porcentagem Lead',
            link: '/graficos/porcentagem-lead'
        },
        {
            text: 'Lead por Região',
            link: '/graficos/lead-regiao'
        }
    ]
};
